...
![The 8 Levels of Agentic Engineering](/images/blog/agentic_thumbnail_notext.jpg)
...
![Same message, fewer tokens — information density was the name of the game (source: humanlayer/12-factor-agents)](/images/blog/context-eng.png)
...
![The compounding loop: plan, delegate, assess, codify — each cycle makes the next one better](/images/blog/compounding-eng.png)
...
![A single PR triggers a review skill that fans out into specialized subagents — each checking a different dimension of quality](/images/blog/review_skill.jpg)
...
![OpenAI's Codex harness — a full observability stack wired into the agent so it can query, correlate, and reason about its own output (source: OpenAI)](/images/blog/harness-eng.png)
...
![Dispatch launching 5 workers across 3 models in parallel — your session stays lean while agents do the work](/images/blog/dispatch.png)
...
![Don't let the same model grade its own exam — separate the implementer from the reviewer](/images/blog/model_separation_implement_review.jpg)
